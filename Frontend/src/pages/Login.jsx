      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8">
        ...
        <div className="flex flex-1 items-center justify-center py-10">
          ...
          >
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">Log in to continue to Pixora.</p>
            ...
            <form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <div className="flex items-center justify-between text-xs">
                <label className="inline-flex items-center gap-2 text-muted-foreground">
                  <input type="checkbox" className="h-3.5 w-3.5 rounded border-border" {...register("remember")} /> Remember me
                </label>
                <a href="#" className="text-foreground hover:underline">Forgot password?</a>
              </div>
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              New to Pixora? <Link to="/register" className="font-medium text-foreground hover:underline">Create an account</Link>
            </p>
          </motion.div>
        </div>
        <Footer />
